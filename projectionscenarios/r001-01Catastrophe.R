...
#######################################################
## HARVEST TO CAUSE DECLINE by r ~ -0.001 or -0.01   ##
## i.e., median trajectory hits r ~ -0.001 or -0.01  ##
#######################################################

## DIPROTODON (DP)
load("DP.RData")
harv.lim <- 0.95 # 1 gives target r ~ -0.01
iter <- 10000
itdiv <- iter/10
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    PA.n.mat[,i+1] <- ifelse((PA.n.mat[,i+1] - harvest) < 0, 0, (PA.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    ZT.n.mat[,i+1] <- ifelse((ZT.n.mat[,i+1] - harvest) < 0, 0, (ZT.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    PH.n.mat[,i+1] <- ifelse((PH.n.mat[,i+1] - harvest) < 0, 0, (PH.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    VU.n.mat[,i+1] <- ifelse((VU.n.mat[,i+1] - harvest) < 0, 0, (VU.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    PG.n.mat[,i+1] <- ifelse((PG.n.mat[,i+1] - harvest) < 0, 0, (PG.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    SS.n.mat[,i+1] <- ifelse((SS.n.mat[,i+1] - harvest) < 0, 0, (SS.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    PT.n.mat[,i+1] <- ifelse((PT.n.mat[,i+1] - harvest) < 0, 0, (PT.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    SO.n.mat[,i+1] <- ifelse((SO.n.mat[,i+1] - harvest) < 0, 0, (SO.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    MN.n.mat[,i+1] <- ifelse((MN.n.mat[,i+1] - harvest) < 0, 0, (MN.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    OR.n.mat[,i+1] <- ifelse((OR.n.mat[,i+1] - harvest) < 0, 0, (OR.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    NR.n.mat[,i+1] <- ifelse((NR.n.mat[,i+1] - harvest) < 0, 0, (NR.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    GN.n.mat[,i+1] <- ifelse((GN.n.mat[,i+1] - harvest) < 0, 0, (GN.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    DN.n.mat[,i+1] <- ifelse((DN.n.mat[,i+1] - harvest) < 0, 0, (DN.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    AL.n.mat[,i+1] <- ifelse((AL.n.mat[,i+1] - harvest) < 0, 0, (AL.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    TC.n.mat[,i+1] <- ifelse((TC.n.mat[,i+1] - harvest) < 0, 0, (TC.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    TH.n.mat[,i+1] <- ifelse((TH.n.mat[,i+1] - harvest) < 0, 0, (TH.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    SH.n.mat[,i+1] <- ifelse((SH.n.mat[,i+1] - harvest) < 0, 0, (SH.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    DM.n.mat[,i+1] <- ifelse((DM.n.mat[,i+1] - harvest) < 0, 0, (DM.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    TA.n.mat[,i+1] <- ifelse((TA.n.mat[,i+1] - harvest) < 0, 0, (TA.n.mat[,i+1] - harvest)) # proportional harvest
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    MR.n.mat[,i+1] <- ifelse((MR.n.mat[,i+1] - harvest) < 0, 0, (MR.n.mat[,i+1] - harvest)) # proportional harvest
