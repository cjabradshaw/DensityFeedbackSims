...
############################################################
## PULSE DISTURBANCE 90% HARVEST AT 20 G ##
############################################################
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      DP.n.mat[,i+1] <- ifelse((DP.n.mat[,i+1] - prop.red*DP.n.mat[,i+1]) < 0, 0, (DP.n.mat[,i+1] - prop.red*DP.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      PA.n.mat[,i+1] <- ifelse((PA.n.mat[,i+1] - prop.red*PA.n.mat[,i+1]) < 0, 0, (PA.n.mat[,i+1] - prop.red*PA.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      ZT.n.mat[,i+1] <- ifelse((ZT.n.mat[,i+1] - prop.red*ZT.n.mat[,i+1]) < 0, 0, (ZT.n.mat[,i+1] - prop.red*ZT.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      PH.n.mat[,i+1] <- ifelse((PH.n.mat[,i+1] - prop.red*PH.n.mat[,i+1]) < 0, 0, (PH.n.mat[,i+1] - prop.red*PH.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      VU.n.mat[,i+1] <- ifelse((VU.n.mat[,i+1] - prop.red*VU.n.mat[,i+1]) < 0, 0, (VU.n.mat[,i+1] - prop.red*VU.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      PG.n.mat[,i+1] <- ifelse((PG.n.mat[,i+1] - prop.red*PG.n.mat[,i+1]) < 0, 0, (PG.n.mat[,i+1] - prop.red*PG.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      SS.n.mat[,i+1] <- ifelse((SS.n.mat[,i+1] - prop.red*SS.n.mat[,i+1]) < 0, 0, (SS.n.mat[,i+1] - prop.red*SS.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      PT.n.mat[,i+1] <- ifelse((PT.n.mat[,i+1] - prop.red*PT.n.mat[,i+1]) < 0, 0, (PT.n.mat[,i+1] - prop.red*PT.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      SO.n.mat[,i+1] <- ifelse((SO.n.mat[,i+1] - prop.red*SO.n.mat[,i+1]) < 0, 0, (SO.n.mat[,i+1] - prop.red*SO.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      MN.n.mat[,i+1] <- ifelse((MN.n.mat[,i+1] - prop.red*MN.n.mat[,i+1]) < 0, 0, (MN.n.mat[,i+1] - prop.red*MN.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      OR.n.mat[,i+1] <- ifelse((OR.n.mat[,i+1] - prop.red*OR.n.mat[,i+1]) < 0, 0, (OR.n.mat[,i+1] - prop.red*OR.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      NR.n.mat[,i+1] <- ifelse((NR.n.mat[,i+1] - prop.red*NR.n.mat[,i+1]) < 0, 0, (NR.n.mat[,i+1] - prop.red*NR.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      GN.n.mat[,i+1] <- ifelse((GN.n.mat[,i+1] - prop.red*GN.n.mat[,i+1]) < 0, 0, (GN.n.mat[,i+1] - prop.red*GN.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      DN.n.mat[,i+1] <- ifelse((DN.n.mat[,i+1] - prop.red*DN.n.mat[,i+1]) < 0, 0, (DN.n.mat[,i+1] - prop.red*DN.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      AL.n.mat[,i+1] <- ifelse((AL.n.mat[,i+1] - prop.red*AL.n.mat[,i+1]) < 0, 0, (AL.n.mat[,i+1] - prop.red*AL.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      TC.n.mat[,i+1] <- ifelse((TC.n.mat[,i+1] - prop.red*TC.n.mat[,i+1]) < 0, 0, (TC.n.mat[,i+1] - prop.red*TC.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      TH.n.mat[,i+1] <- ifelse((TH.n.mat[,i+1] - prop.red*TH.n.mat[,i+1]) < 0, 0, (TH.n.mat[,i+1] - prop.red*TH.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      SH.n.mat[,i+1] <- ifelse((SH.n.mat[,i+1] - prop.red*SH.n.mat[,i+1]) < 0, 0, (SH.n.mat[,i+1] - prop.red*SH.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      DM.n.mat[,i+1] <- ifelse((DM.n.mat[,i+1] - prop.red*DM.n.mat[,i+1]) < 0, 0, (DM.n.mat[,i+1] - prop.red*DM.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      TA.n.mat[,i+1] <- ifelse((TA.n.mat[,i+1] - prop.red*TA.n.mat[,i+1]) < 0, 0, (TA.n.mat[,i+1] - prop.red*TA.n.mat[,i+1])) # pulse harvest
    }
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    if (i == pulset) {
      MR.n.mat[,i+1] <- ifelse((MR.n.mat[,i+1] - prop.red*MR.n.mat[,i+1]) < 0, 0, (MR.n.mat[,i+1] - prop.red*MR.n.mat[,i+1])) # pulse harvest
    }
