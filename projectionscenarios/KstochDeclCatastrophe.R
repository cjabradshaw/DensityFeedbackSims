...
############################################
## CARRYING CAPACITY DECLINES at ~ -0.001 ##
############################################
...
PA.b.lp.vec2 <- rnorm(n=length(PA.b.lp.vec1), mean=PA.b.lp.vec1, sd=0.05*PA.b.lp.vec1[1])
...
ZT.b.lp.vec2 <- rnorm(n=length(ZT.b.lp.vec1), mean=ZT.b.lp.vec1, sd=0.05*ZT.b.lp.vec1[1])
...
PH.b.lp.vec2 <- rnorm(n=length(PH.b.lp.vec1), mean=PH.b.lp.vec1, sd=0.05*PH.b.lp.vec1[1])
...
VU.b.lp.vec2 <- rnorm(n=length(VU.b.lp.vec1), mean=VU.b.lp.vec1, sd=0.05*VU.b.lp.vec1[1])
...
PG.b.lp.vec2 <- rnorm(n=length(PG.b.lp.vec1), mean=PG.b.lp.vec1, sd=0.05*PG.b.lp.vec1[1])
...
SS.b.lp.vec2 <- rnorm(n=length(SS.b.lp.vec1), mean=SS.b.lp.vec1, sd=0.05*SS.b.lp.vec1[1])
...
PT.b.lp.vec2 <- rnorm(n=length(PT.b.lp.vec1), mean=PT.b.lp.vec1, sd=0.05*PT.b.lp.vec1[1])
...
SO.b.lp.vec2 <- rnorm(n=length(SO.b.lp.vec1), mean=SO.b.lp.vec1, sd=0.05*SO.b.lp.vec1[1])
...
MN.b.lp.vec2 <- rnorm(n=length(MN.b.lp.vec1), mean=MN.b.lp.vec1, sd=0.05*MN.b.lp.vec1[1])
...
OR.b.lp.vec2 <- rnorm(n=length(OR.b.lp.vec1), mean=OR.b.lp.vec1, sd=0.05*OR.b.lp.vec1[1])
...
NR.b.lp.vec2 <- rnorm(n=length(NR.b.lp.vec1), mean=NR.b.lp.vec1, sd=0.05*NR.b.lp.vec1[1])
...
GN.b.lp.vec2 <- rnorm(n=length(GN.b.lp.vec1), mean=GN.b.lp.vec1, sd=0.05*GN.b.lp.vec1[1])
...
DN.b.lp.vec2 <- rnorm(n=length(DN.b.lp.vec1), mean=DN.b.lp.vec1, sd=0.05*DN.b.lp.vec1[1])
...
AL.b.lp.vec2 <- rnorm(n=length(AL.b.lp.vec1), mean=AL.b.lp.vec1, sd=0.05*AL.b.lp.vec1[1])
...
TC.b.lp.vec2 <- rnorm(n=length(TC.b.lp.vec1), mean=TC.b.lp.vec1, sd=0.05*TC.b.lp.vec1[1])
...
TH.b.lp.vec2 <- rnorm(n=length(TH.b.lp.vec1), mean=TH.b.lp.vec1, sd=0.05*TH.b.lp.vec1[1])
...
SH.b.lp.vec2 <- rnorm(n=length(SH.b.lp.vec1), mean=SH.b.lp.vec1, sd=0.05*SH.b.lp.vec1[1])
...
DM.b.lp.vec2 <- rnorm(n=length(DM.b.lp.vec1), mean=DM.b.lp.vec1, sd=0.05*DM.b.lp.vec1[1])
...
TA.b.lp.vec2 <- rnorm(n=length(TA.b.lp.vec1), mean=TA.b.lp.vec1, sd=0.05*TA.b.lp.vec1[1])
...
MR.b.lp.vec2 <- rnorm(n=length(MR.b.lp.vec1), mean=MR.b.lp.vec1, sd=0.05*MR.b.lp.vec1[1])
