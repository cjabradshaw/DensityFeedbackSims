...
catProbInc <- 19.5
cat.prob <- ifelse(((0.14/PA.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/PA.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(PA.popmat[2:(PA.age.max+1),]) <- (PA.s.stoch[-(PA.age.max+1)])
    PA.popmat[PA.age.max+1,PA.age.max+1] <- (PA.s.stoch[PA.age.max+1])
...
# total N
PA.n.md <- apply(PA.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, PA.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 21.4
cat.prob <- ifelse(((0.14/ZT.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/ZT.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(ZT.popmat[2:(ZT.age.max+1),]) <- (ZT.s.stoch[-(ZT.age.max+1)])
    ZT.popmat[ZT.age.max+1,ZT.age.max+1] <- (ZT.s.stoch[ZT.age.max+1])
...
# total N
ZT.n.md <- apply(ZT.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, ZT.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 22.6
cat.prob <- ifelse(((0.14/PH.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/PH.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(PH.popmat[2:(PH.age.max+1),]) <- (PH.s.stoch[-(PH.age.max+1)])
    PH.popmat[PH.age.max+1,PH.age.max+1] <- (PH.s.stoch[PH.age.max+1])
...
# total N
PH.n.md <- apply(PH.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, PH.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 17.6
cat.prob <- ifelse(((0.14/VU.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/VU.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(VU.popmat[2:(VU.age.max+1),]) <- (VU.s.stoch[-(VU.age.max+1)])
...
# total N
VU.n.md <- apply(VU.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, VU.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 22.5
cat.prob <- ifelse(((0.14/PG.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/PG.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(PG.popmat[2:(PG.age.max+1),]) <- (PG.s.stoch[-(PG.age.max+1)])
    PG.popmat[PG.age.max+1,PG.age.max+1] <- (PG.s.stoch[PG.age.max+1])
...
# total N
PG.n.md <- apply(PG.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, PG.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 25
cat.prob <- ifelse(((0.14/SS.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/SS.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(SS.popmat[2:(SS.age.max+1),]) <- (SS.s.stoch[-(SS.age.max+1)])
    SS.popmat[SS.age.max+1,SS.age.max+1] <- (SS.s.stoch[SS.age.max+1])
...
# total N
SS.n.md <- apply(SS.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, SS.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 25.26
cat.prob <- ifelse(((0.14/PT.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/PT.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(PT.popmat[2:(PT.age.max+1),]) <- (PT.s.stoch[-(PT.age.max+1)])
    PT.popmat[PT.age.max+1,PT.age.max+1] <- (PT.s.stoch[PT.age.max+1])
...
# total N
PT.n.md <- apply(PT.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, PT.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 25.72
cat.prob <- ifelse(((0.14/SO.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/SO.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(SO.popmat[2:(SO.age.max+1),]) <- (SO.s.stoch[-(SO.age.max+1)])
    SO.popmat[SO.age.max+1,SO.age.max+1] <- (SO.s.stoch[SO.age.max+1])
...
# total N
SO.n.md <- apply(SO.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, SO.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 25.8
cat.prob <- ifelse(((0.14/MN.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/MN.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(MN.popmat[2:(MN.age.max+1),]) <- (MN.s.stoch[-(MN.age.max+1)])
    MN.popmat[MN.age.max+1,MN.age.max+1] <- (MN.s.stoch[MN.age.max+1])
...
# total N
MN.n.md <- apply(MN.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, MN.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 28.2
cat.prob <- ifelse(((0.14/OR.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/OR.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(OR.popmat[2:(OR.age.max+1),]) <- (OR.s.stoch[-(OR.age.max+1)])
    OR.popmat[OR.age.max+1,OR.age.max+1] <- (OR.s.stoch[OR.age.max+1])
...
# total N
OR.n.md <- apply(OR.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, OR.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 33
cat.prob <- ifelse(((0.14/NR.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/NR.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(NR.popmat[2:(NR.age.max+1),]) <- (NR.s.stoch[-(NR.age.max+1)])
    NR.popmat[NR.age.max+1,NR.age.max+1] <- (NR.s.stoch[NR.age.max+1])
...
# total N
NR.n.md <- apply(NR.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, NR.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 11.2
cat.prob <- ifelse(((0.14/GN.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/GN.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(GN.popmat[2:(GN.age.max+1),]) <- (GN.s.stoch[-(GN.age.max+1)])
    GN.popmat[GN.age.max+1,GN.age.max+1] <- (GN.s.stoch[GN.age.max+1])
...
# total N
GN.n.md <- apply(GN.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, GN.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 9.6
cat.prob <- ifelse(((0.14/DN.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/DN.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(DN.popmat[2:(DN.age.max+1),]) <- (DN.s.stoch[-(DN.age.max+1)])
    DN.popmat[DN.age.max+1,DN.age.max+1] <- (DN.s.stoch[DN.age.max+1])
...
# total N
DN.n.md <- apply(DN.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, DN.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 19
cat.prob <- ifelse(((0.14/AL.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/AL.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(AL.popmat[2:(AL.age.max+1),]) <- (AL.s.stoch[-(AL.age.max+1)])
    AL.popmat[AL.age.max+1,AL.age.max+1] <- (AL.s.stoch[AL.age.max+1])
...
# total N
AL.n.md <- apply(AL.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, AL.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 25.7
cat.prob <- ifelse(((0.14/TC.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/TC.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(TC.popmat[2:(TC.age.max+1),]) <- (TC.s.stoch[-(TC.age.max+1)])
    TC.popmat[TC.age.max+1,TC.age.max+1] <- (TC.s.stoch[TC.age.max+1])
...
# total N
TC.n.md <- apply(TC.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, TC.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 28.2
cat.prob <- ifelse(((0.14/TH.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/TH.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(TH.popmat[2:(TH.age.max+1),]) <- (TH.s.stoch[-(TH.age.max+1)])
...
# total N
TH.n.md <- apply(TH.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, TH.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 5.61
cat.prob <- ifelse(((0.14/SH.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/SH.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(SH.popmat[2:(SH.age.max+1),]) <- (SH.s.stoch[-1])
...
# total N
SH.n.md <- apply(SH.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, SH.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 14.1
cat.prob <- ifelse(((0.14/DM.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/DM.gen.l) * catProbInc))
cat.prob
catMag <- 0.10
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(DM.popmat[2:(DM.age.max+1),]) <- (DM.s.stoch[-1])
...
# total N
DM.n.md <- apply(DM.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, DM.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 22.56
cat.prob <- ifelse(((0.14/TA.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/TA.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(TA.popmat[2:(TA.age.max+1),]) <- (TA.s.stoch[-(TA.age.max+1)])
...
# total N
TA.n.md <- apply(TA.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, TA.n.md, type="l", lty=1, lwd=0.8)
...
catProbInc <- 24.5
cat.prob <- ifelse(((0.14/MR.gen.l) * catProbInc) > 0.99, 0.99, ((0.14/MR.gen.l) * catProbInc))
cat.prob
catMag <- 0.5
...
for (e in 1:iter) {
  ...
  for (i in 1:t) {
    ...
    diag(MR.popmat[2:(MR.age.max+1),]) <- (MR.s.stoch[-(MR.age.max+1)])
...
# total N
MR.n.md <- apply(MR.n.sums.matb, MARGIN=2, mean, na.rm=T) # mean over all iterations
...
plot(yrs, MR.n.md, type="l", lty=1, lwd=0.8)
