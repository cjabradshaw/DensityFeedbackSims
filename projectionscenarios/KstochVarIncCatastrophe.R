...
## BUT VARIANCE DOUBLES BY END OF PROJECTION           ##
#########################################################
...
save.image("DPKstochVarInc.RData")
rm(list = ls())
...
divK <- 2.1
PA.b.lp.vec1 <- seq(PA.b.lp, PA.b.lp/divK, by = -((PA.b.lp - PA.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
PA.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  PA.b.lp.vec2[f] <- rnorm(1, mean=PA.b.lp, sd=SD.incr[f]*PA.b.lp)
}
...
save.image("PAKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.9
ZT.b.lp.vec1 <- seq(ZT.b.lp, ZT.b.lp/divK, by = -((ZT.b.lp - ZT.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
ZT.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  ZT.b.lp.vec2[f] <- rnorm(1, mean=ZT.b.lp, sd=SD.incr[f]*ZT.b.lp)
}
...
save.image("ZTKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.74
PH.b.lp.vec1 <- seq(PH.b.lp, PH.b.lp/divK, by = -((PH.b.lp - PH.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
PH.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  PH.b.lp.vec2[f] <- rnorm(1, mean=PH.b.lp, sd=SD.incr[f]*PH.b.lp)
}
...
save.image("PHKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.57
VU.b.lp.vec1 <- seq(VU.b.lp, VU.b.lp/divK, by = -((VU.b.lp - VU.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
VU.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  VU.b.lp.vec2[f] <- rnorm(1, mean=VU.b.lp, sd=SD.incr[f]*VU.b.lp)
}
...
save.image("VUKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.57
PG.b.lp.vec1 <- seq(PG.b.lp, PG.b.lp/divK, by = -((PG.b.lp - PG.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
PG.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  PG.b.lp.vec2[f] <- rnorm(1, mean=PG.b.lp, sd=SD.incr[f]*PG.b.lp)
}
...
save.image("PGKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.47
SS.b.lp.vec1 <- seq(SS.b.lp, SS.b.lp/divK, by = -((SS.b.lp - SS.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
SS.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  SS.b.lp.vec2[f] <- rnorm(1, mean=SS.b.lp, sd=SD.incr[f]*SS.b.lp)
}
...
save.image("SSKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.49
PT.b.lp.vec1 <- seq(PT.b.lp, PT.b.lp/divK, by = -((PT.b.lp - PT.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
PT.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  PT.b.lp.vec2[f] <- rnorm(1, mean=PT.b.lp, sd=SD.incr[f]*PT.b.lp)
}
...
save.image("PTKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.42
SO.b.lp.vec1 <- seq(SO.b.lp, SO.b.lp/divK, by = -((SO.b.lp - SO.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
SO.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  SO.b.lp.vec2[f] <- rnorm(1, mean=SO.b.lp, sd=SD.incr[f]*SO.b.lp)
}
...
save.image("SOKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.37
MN.b.lp.vec1 <- seq(MN.b.lp, MN.b.lp/divK, by = -((MN.b.lp - MN.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
MN.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  MN.b.lp.vec2[f] <- rnorm(1, mean=MN.b.lp, sd=SD.incr[f]*MN.b.lp)
}
...
save.image("MNKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.36
OR.b.lp.vec1 <- seq(OR.b.lp, OR.b.lp/divK, by = -((OR.b.lp - OR.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
OR.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  OR.b.lp.vec2[f] <- rnorm(1, mean=OR.b.lp, sd=SD.incr[f]*OR.b.lp)
}
...
save.image("ORKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.27
NR.b.lp.vec1 <- seq(NR.b.lp, NR.b.lp/divK, by = -((NR.b.lp - NR.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
NR.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  NR.b.lp.vec2[f] <- rnorm(1, mean=NR.b.lp, sd=SD.incr[f]*NR.b.lp)
}
...
save.image("NRKstochVarInc.RData")
rm(list = ls())
...
divK <- 2.2
GN.b.lp.vec1 <- seq(GN.b.lp, GN.b.lp/divK, by = -((GN.b.lp - GN.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
GN.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  GN.b.lp.vec2[f] <- rnorm(1, mean=GN.b.lp, sd=SD.incr[f]*GN.b.lp)
}
...
save.image("GNKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.3
DN.b.lp.vec1 <- seq(DN.b.lp, DN.b.lp/divK, by = -((DN.b.lp - DN.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
DN.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  DN.b.lp.vec2[f] <- rnorm(1, mean=DN.b.lp, sd=SD.incr[f]*DN.b.lp)
}
...
save.image("DNKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.3
AL.b.lp.vec1 <- seq(AL.b.lp, AL.b.lp/divK, by = -((AL.b.lp - AL.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
AL.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  AL.b.lp.vec2[f] <- rnorm(1, mean=AL.b.lp, sd=SD.incr[f]*AL.b.lp)
}
...
save.image("ALKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.9
TC.b.lp.vec1 <- seq(TC.b.lp, TC.b.lp/divK, by = -((TC.b.lp - TC.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
TC.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  TC.b.lp.vec2[f] <- rnorm(1, mean=TC.b.lp, sd=SD.incr[f]*TC.b.lp)
}
...
save.image("TCKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.32
TH.b.lp.vec1 <- seq(TH.b.lp, TH.b.lp/divK, by = -((TH.b.lp - TH.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
TH.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  TH.b.lp.vec2[f] <- rnorm(1, mean=TH.b.lp, sd=SD.incr[f]*TH.b.lp)
}
...
save.image("THKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.18
SH.b.lp.vec1 <- seq(SH.b.lp, SH.b.lp/divK, by = -((SH.b.lp - SH.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
SH.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  SH.b.lp.vec2[f] <- rnorm(1, mean=SH.b.lp, sd=SD.incr[f]*SH.b.lp)
}
...
save.image("SHKstochVarInc.RData")
rm(list = ls())
...
divK <- 1.12
DM.b.lp.vec1 <- seq(DM.b.lp, DM.b.lp/divK, by = -((DM.b.lp - DM.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
DM.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  DM.b.lp.vec2[f] <- rnorm(1, mean=DM.b.lp, sd=SD.incr[f]*DM.b.lp)
}
...
save.image("DMKstochVarInc.RData")
rm(list = ls())
...
divK <- 2
TA.b.lp.vec1 <- seq(TA.b.lp, TA.b.lp/divK, by = -((TA.b.lp - TA.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
TA.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  TA.b.lp.vec2[f] <- rnorm(1, mean=TA.b.lp, sd=SD.incr[f]*TA.b.lp)
}
...
save.image("TAKstochVarInc.RData")
rm(list = ls())
...
divK <- 2.1
MR.b.lp.vec1 <- seq(MR.b.lp, MR.b.lp/divK, by = -((MR.b.lp - MR.b.lp/divK)/(t-1)))

SDpc <- 0.05
SD.incr <- seq(from=SDpc, to=2*SDpc, by=(2*SDpc-SDpc)/(t-1))
MR.b.lp.vec2 <- rep(NA,t)
for (f in 1:t) {
  MR.b.lp.vec2[f] <- rnorm(1, mean=MR.b.lp, sd=SD.incr[f]*MR.b.lp)
}
...
save.image("MRKstochVarInc.RData")
rm(list = ls())
