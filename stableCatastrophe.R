...
save.image("DPstable40G.RData")
rm(list = ls())



## PALORCHESTES (PA)
load("~/Documents/Papers/Density Dependence/Component-Ensemble simulation/analysis/matrix inputs/PA.RData")
iter <- 10000
itdiv <- iter/10
...
save.image("~/Documents/Papers/Density Dependence/Component-Ensemble simulation/analysis/matrix inputs/ZTstable40G.RData")
rm(list = ls())
...
save.image("~/Documents/Papers/Density Dependence/Component-Ensemble simulation/analysis/matrix inputs/SHstable40G.RData")
rm(list = ls())
